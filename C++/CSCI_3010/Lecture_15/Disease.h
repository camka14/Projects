...
// Go ahead and make up answers for the other traits.
    static Disease* GetFlu(){
        Disease *D = new Disease("Flu", true, false, false, true, 0.1, 0.1, 0.01, 0.01);
        return D;
    };
...
// imagination to fill in the other fields.
    static Disease* GetCold(){
        Disease *D = new Disease("Cold", true, false, true, false, 0.2, 0.2, 0.1, 0.001);
        return D;
    };
...
// can be something that you've made up).
    static Disease* GetCancer(){
        Disease *D = new Disease("Cancer", false, true, false, false, 0.001, 0.005, 0.01, 0.3);
        return D;
    };
