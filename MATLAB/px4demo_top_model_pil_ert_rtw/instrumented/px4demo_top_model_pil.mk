...
## Generated on : Tue Aug 31 08:49:10 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/px4demo_top_model_pil.pre.o
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/px4demo_top_model_pil.pre.o
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/px4demo_top_model_pil_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/serial -IC:/PROGRA~3/MATLAB/SupportPackages/R2020b/toolbox/target/shared/externalmode_daemon/include -IC:/PROGRA~3/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/px4/include
...
DEFINES_ = -DMW_STANDALONE_EXECUTION_PROFILER_ON -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_PX4_DISABLE_MAVLINK=1
...
SRCS = $(START_DIR)/px4demo_top_model_pil_ert_rtw/px4demo_top_model_pil.cpp $(START_DIR)/px4demo_top_model_pil_ert_rtw/px4demo_top_model_pil_data.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/px4/src/MW_PX4_TaskControl.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/px4/src/nuttxinitialize.cpp

MAIN_SRC = $(START_DIR)/px4demo_top_model_pil_ert_rtw/ert_main.cpp
...
OBJS = px4demo_top_model_pil.cpp.o px4demo_top_model_pil_data.cpp.o MW_PX4_TaskControl.cpp.o nuttxinitialize.cpp.o
...
%.o : $(START_DIR)/px4demo_top_model_pil_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/px4demo_top_model_pil_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/px4demo_top_model_pil_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


px4demo_top_model_pil.cpp.o : $(START_DIR)/px4demo_top_model_pil_ert_rtw/px4demo_top_model_pil.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


px4demo_top_model_pil_data.cpp.o : $(START_DIR)/px4demo_top_model_pil_ert_rtw/px4demo_top_model_pil_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
